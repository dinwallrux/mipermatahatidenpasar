@extends('layouts.card_blank', ['page_title' => 'Kelas', 'title' => 'Edit Kelas'])
    ...
    <div class="form-group row">
        <div class="col-sm-6 mb-3 mb-sm-0">
            ...
            <input type="text" class="form-control form-control-user" id="nama_rombel"
                placeholder="Nama Rombel" @error('nama_rombel') is-invalid @enderror" name="nama_rombel" value="{{ $data->nama_rombel }}" autocomplete="nama_rombel" autofocus>
            @error('nama_rombel')
    ...
    <div class="form-group row">
        ...
        <div class="col-sm-6">
            ...
            <select name="id_tenaga_pendidik" class="form-control form-control-user" id="id_tenaga_pendidik">
                ...
                <option {{ $data->guru->nama == $guru->nama ? 'selected' : '' }} value="{{ $guru->id }}">{{ $guru->nama }}</option>
                @endforeach
            </select>
        </div>
    </div>
    <div class="form-group row">
        ...
        <div class="col-sm-6">
            ...
            <input type="text" class="form-control form-control-user" id="tahun_ajaran"
                placeholder="Tahun Ajaran: 2021/2022" @error('tahun_ajaran') is-invalid @enderror" name="tahun_ajaran" value="{{ $data->tahun_ajaran }}" autocomplete="tahun_ajaran" autofocus>
            @error('tahun_ajaran')
                <span class="invalid-feedback" role="alert">
                    <strong>{{ $message }}</strong>
                </span>
