@extends('layouts.card_blank', ['page_title' => 'Peran', 'title' => 'Ubah Peran'])

@section('content_2')
<form class="ruang-form" method="POST" enctype="multipart/form-data" action="{{ route('peran.proses.update') }}">
    @csrf
